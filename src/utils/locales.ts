...
import { KEY_LANGUAGE, getItem } from "src/services/LocalStorage";
import localeNames from "src/translations/localeNames.json";
...
const normalizeIsoCode = (str = "") => {
  // To ensure all browsers' iso code are the same.
...
export const getLocale = () => {
  ...
  const mappedLang =
    LocaleMap(rawLang) || LocaleMap(rawLang.split("-")[0]) || DEFAULT_LOCALE;
